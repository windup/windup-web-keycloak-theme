...
<@layout.registrationLayout displayInfo=true; section>
    ...
    <#elseif section = "logo">
        <span id="mta-title">
            <p>
                <strong class="visible-xs-inline">MTR&nbsp;</strong>
                <strong class="hidden-xs">Migration Toolkit for Runtimes</strong>
    ...
    <#elseif section = "info">
        <p>
            <strong class="welcome-help-text"> Welcome to the Migration Toolkit for Runtimes Web Console. </strong>
        </p>
        <p>
            Learn more about Migration Toolkit for Runtimes from the
